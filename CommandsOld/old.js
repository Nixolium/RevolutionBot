const partyData = require("../Storage/partyData.json")
...
module.exports = function (message) {
    ...
    if (words.length == 1) {
        ...
        message += (userData[partmembers[0]].username + " (Leader)\n");
        ...
        if (party == "None") {
            ...
            */
            ...
            functions.sendMessage(message.channel, !partyData[partyName])
            if (!partyData[partyName]) {
                functions.sendMessage(message.channel, partyName)
                partyData[partyName] = {};
